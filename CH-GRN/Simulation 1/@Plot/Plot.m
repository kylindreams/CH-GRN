...
classdef Plot
   ...
   methods (Static)
       ...
       function  plot_target(target)
            hold on;
            %目标的运动轨迹线
            plot([8.8,10],[14.2,14.2],'-','color','k','LineWidth',1.2)
            plot([6,5],[7.5,8.5],'-','color','k','LineWidth',1.2)
            plot([5,6],[8.5,8.2],'-','color','k','LineWidth',1.2)
            plot([14.5,14.5],[3,4.2],'-','color','k','LineWidth',1.2)
            %目标点
