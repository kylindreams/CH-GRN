...
classdef Target
   ...
   methods  
       ...
       theta_occupy = cal_targetsurroundingtheta(obj, robot, target,simulation_robot,id)
       density = cal_density(obj, robot, target, simulation_robot)
    end   
end 
